...
RateRenter::RateRenter(std::string renterid, std::string ownerid, int score, std::string comment) : renterid(renterid), ownerid(ownerid), score(score), comment(comment){
