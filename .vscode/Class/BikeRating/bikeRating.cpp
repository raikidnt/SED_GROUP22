...
std::string BikeRatingIDgenerate(){
   ...
   return ("BikeRating - "+std::to_string(num));
}

BikeRating::BikeRating(){};

BikeRating::BikeRating(std::string rateBikeID, int score, std::string comment): rateBikeID(rateBikeID), score(score), comment(comment){};
